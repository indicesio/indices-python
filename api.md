...
- <code title="post /v1beta/tasks/{id}/complete-manual-session">client.tasks.<a href="./src/indices/resources/tasks.py">complete_manual_session</a>(id) -> <a href="./src/indices/types/task.py">Task</a></code>
